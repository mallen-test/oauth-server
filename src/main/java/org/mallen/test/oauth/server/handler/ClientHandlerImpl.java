...
public class ClientHandlerImpl implements ClientHandler {
    ...
    public Page<Client> find(String clientId, String clientSecurity, Integer pageIndex, Integer pageSize) {
        ...
        if (!StringUtils.isEmpty(clientSecurity)) {
            BooleanExpression securityExpression = QClient.client.clientSecurity.likeIgnoreCase(clientSecurity);
    ...
    @Override
    public void add(String clientId, String clientSecurity, String remark) {
        Client client = new Client(clientId, clientSecurity, remark);
